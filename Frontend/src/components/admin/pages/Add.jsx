...
const AddProduct = () => {
  ...
  const handleFileChange = (e, index) => {
    const file = Array.from(e.target.files); //files meh files as a array
    if (file) {
      const updatedImages = [...formData.images];
      const updatedPreview = [...formData.preview];
      updatedImages[index] = file[0];
      updatedPreview[index] = URL.createObjectURL(file[0]);
      setFormData({
        ...formData,
      ...
      setFormData((prevformData) => ({
        ...prevformData,
        images: [...prevformData.images, ...file], //img1, img2 + img3, img4
        preview: [...prevformData.preview, ...previewUrls],
      }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        ...
        formDataToSend, // Sending the product data
        {
  ...
  return (
    <div className="p-5">
      ...
      <div className="imageSection text-black font-semibold text-lg">
        Upload Image
