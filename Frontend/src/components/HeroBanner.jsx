...
const HeroBanner = () => { 
  ...
  // Video sources array
  const videos = [
    { src: ps5, title: "Play Station 5", title2: "Play LIke Never Before",  description: "The Ultimate Gamng Machine", offer: "Avail benefits worth ₹9999*" },
    { src: galaxys24, title: "Samsung ",title2: "Galaxy S24 Ultra", description: "Galaxy AI is here", offer: "Avail benefits worth ₹9999*" },
    { src: macbook1, title: "Apple", title2: "MacBook Air 13",  description: "Supercharged by M3", offer: "Avail benefits worth ₹4000*" },
    { src: fashion, title: "H&M", title2: "Men | Women | Kids", description: "Fashion & Quality at Best Price", offer: "Avail benefits worth ₹1200*" },
    { src: ps5, title: "Play Station 5", title2: "Play Like Never Before", description: "The Ultimate Gaming Machine", offer: "Avail benefits worth ₹9999*" },
    { src: galaxys24, title: "Samsung ", title2: "Galaxy S24 Ultra",  description: "Galaxy AI is here ", offer: "Avail benefits worth ₹9999*" },
  ...
  return ( 
    <>
      ...
      <div className="h-[91vh] w-full relative overflow-hidden bg-black">
        <div ref={gsapBannerContainer} className="flex w-[600%] h-[91vh] absolute left-[-100%]">
          {videos.map((video, index) => (
            <div key={index} className="w-full h-full bg-black relative">
              ...
              <p className="absolute text-white font-normal leading-tight text-7xl top-6 left-5">{video.title}</p>
              <p className="absolute text-white font-normal leading-tight text-5xl top-28 left-5">{video.title2}</p>
              <p className="absolute text-white font-normal text-4xl right-10 bottom-40">{video.description}</p>
              <p className="absolute text-white font-normal text-3xl right-10 bottom-28">{video.offer}</p>
            </div>
          ))}
        </div>
